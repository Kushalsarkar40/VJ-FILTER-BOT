...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5854798620').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002441724733').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002260752244') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002543377446')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002441724733')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002537927055').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kushalsarkar302:oooAJyDxlbxlGzka@cluster0.sbvyl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# ITrEMIUM_AND_REFERAL_MODE is True Then Fill Below Variable, If Flase Then No Need To Fill.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviebotstudio')
CHNL_LNK = environ.get('CHNL_LINK', 'https://t.me/moviestudio444')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/moviebotstudio') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/kushalsark')
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'https://shrinkearn.com/api')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '93dcfa9c7179852ebafd7a02b4cf33d53d5a2241')
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'https://shrinkearn.com/api')
SHORTLINK_API = environ.get('SHORTLINK_API', '93dcfa9c7179852ebafd7a02b4cf33d53d5a2241')
